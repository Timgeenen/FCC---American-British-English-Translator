...
suite('Unit Tests', () => {
    ...
    suite('British to American translations', () => {
        ...
        test('Translate The car boot sale at Boxted Airfield was called off. to American English', () => {
            assert.equal(translate.britishToAmerican('The car boot sale at Boxted Airfield was called off.'), 'The <span class="highlight">swap meet</span> Boxted Airfield was called off.');
        });
